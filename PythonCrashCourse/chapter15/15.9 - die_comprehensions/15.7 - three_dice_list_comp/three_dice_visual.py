...
# Roll 3 D6 dice n times -- list comprehension
results = [die_1.roll() + die_2.roll() + die_3.roll() for roll in range(5_000_000)]
...
# Analyze results -- list comprehension
frequencies = [results.count(side) for side in die_sides]
